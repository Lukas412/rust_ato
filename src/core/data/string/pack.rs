...
impl BuildableWithRequirements<StringValue, BuildError, ElementContainer> for StringPack {
  fn build_with_requirements(&self, requirements: &ElementContainer) -> Result<StringValue, BuildError> {
    todo!()
  }
}